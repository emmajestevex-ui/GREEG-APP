...
Private client build with Supabase key activation and an automatic bundled patch.
...
- Creates the internal `asse` and `144 fps` patches automatically after activation.
